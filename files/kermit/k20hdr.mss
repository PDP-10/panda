@Comment(-*-SCRIBE-*-)
@Comment(SCRIBE Text Formatter Input for the DEC-20 Kermit User Guide)
...
@Case{Device,
 ...
 Imprint10="@Use(AuxFile='K20IMP.AUX')
    @Define<Q,FaceCode U>
 ...
 Imagen300="@Use(AuxFile='K20IM3.AUX')
    @Define<Q,FaceCode U>
    @Define(QQ,FaceCode U,AfterEntry=[@r<``>],BeforeExit=[@r<''>])
    @Define<SubH,Use Display,FaceCode B,Above 1.6,Below 1>
    @define<xx,use b,font bodyfont>
...
@MajorHeading(DECSYSTEM-20 KERMIT USER GUIDE)
