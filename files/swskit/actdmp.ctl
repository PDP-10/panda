...
!SYSTEMS.
!
! FUNCTION:	THIS CONTROL FILE BUILDS ACTDMP FROM ITS BASIC 
...
!
@VDIRECT SYS:MACRO.EXE,SYS:LINK.EXE,SYS:CREF.EXE,ACTDMP.MAC,
@CHECKSUM SEQ
@
...
@INFORMATION VERSION
!
@COMPILE /CREF/COMPILE ACTDMP.MAC
!
@R CREF
*FOO:ACTDMP.LST=ACTDMP.CRF
!
@LOAD ACTDMP
!
@SAVE ACTDMP
