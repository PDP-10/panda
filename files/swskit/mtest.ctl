...
!SYSTEMS.
!
! FUNCTION:	THIS CONTROL FILE BUILDS MTEST FROM ITS BASIC 
...
!
@VDIRECT SYS:MACRO.EXE,SYS:LINK.EXE,SYS:CREF.EXE,MTEST.MAC,
@CHECKSUM SEQ
@
...
@INFORMATION VERSION
!
@COMPILE /CREF/COMPILE MTEST.MAC
!
@R CREF
*FOO:MTEST.LST=MTEST.CRF
!
@LOAD MTEST
!
@SAVE MTEST
