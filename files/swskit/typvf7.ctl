...
!SYSTEMS.
!
! FUNCTION:	THIS CONTROL FILE BUILDS TYPVF7 FROM ITS BASIC 
...
!
@VDIRECT SYS:MACRO.EXE,SYS:LINK.EXE,SYS:CREF.EXE,TYPVF7.MAC,
@CHECKSUM SEQ
@
...
@INFORMATION VERSION
!
@COMPILE /CREF/COMPILE TYPVF7.MAC
!
@R CREF
*FOO:TYPVF7.LST=TYPVF7.CRF
!
@LOAD TYPVF7
!
@SAVE TYPVF7
