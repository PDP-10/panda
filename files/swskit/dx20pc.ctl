...
!SYSTEMS.
!
! FUNCTION:	THIS CONTROL FILE BUILDS DX20PC FROM ITS BASIC 
...
!
@VDIRECT SYS:MACRO.EXE,SYS:LINK.EXE,SYS:CREF.EXE,DX20PC.MAC,
@CHECKSUM SEQ
@
...
@INFORMATION VERSION
!
@COMPILE /CREF/COMPILE DX20PC.MAC
!
@R CREF
*FOO:DX20PC.LST=DX20PC.CRF
!
@LOAD DX20PC
!
@SAVE DX20PC
