...
Document type definition for Form-2 Report.  This form began as
a duplicate of regular Form-0 report, and is evolving slowly
away from it

}
@Marker(Make,2Report,XGP)
...
@set(page=0)
@PageHeading(Center "@value(page)")
@Marker(Make,2Report,File,PagedFile,CRT)
