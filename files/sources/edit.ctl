...
!
! FUNCTION:	THIS CONTROL FILE BUILDS EDIT FROM ITS BASIC 
...
!
! NOTE THAT THE MESSAGE "%FILE NOT FOUND - MONSYM.UNV" IS
! CORRECT!!! THE FILE MONSYM.UNV SHOULD NOT BE IN THE CONNECTED
! DIRECTORY. IT SHOULD ONLY BE IN SYS:
!
@VDIRECT SYS:MACRO.EXE,SYS:LINK.EXE,SYS:CREF.EXE,EDIT.MAC,MONSYM.UNV,
@CHECKSUM SEQ
@
...
@INFORMATION VERSION
!
@COMPILE /CREF EDIT.MAC
!
;SM	@R CREF
;SM	*FOO:EDIT.LST=EDIT.CRF
!
@LOAD EDIT
!
@SAVE EDIT
