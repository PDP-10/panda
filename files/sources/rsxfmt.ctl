...
!
! FUNCTION:	THIS CONTROL FILE BUILDS RSXFMT FROM ITS BASIC 
...
!
@VDIRECT SYS:MACRO.EXE,SYS:LINK.EXE,SYS:PA1050.EXE,SYS:CREF.EXE,RSXFMT.MAC,
@CHECKSUM SEQ
@
...
@INFORMATION VERSION
!
@COMPILE /CREF RSXFMT.MAC
!
@R CREF
*FOO:RSXFMT.LST=RSXFMT.CRF
!
@LOAD RSXFMT
!
@SAVE RSXFMT
