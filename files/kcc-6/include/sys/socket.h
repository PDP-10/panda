...
/* Disabled by R. Helliwell, 4-Jan-94 until setsockopt() implemented. */
...
#pragma private define getsockname gscknm
int	getsockname __P((int, struct sockaddr *, int *));
#pragma private define getsockopt gsckop
...
#pragma private define setsockopt ssckop
int	setsockopt __P((int, int, int, const void *, int));
int	shutdown __P((int, int));
int	socket __P((int, int, int));
#pragma private define socketpair scktpr
