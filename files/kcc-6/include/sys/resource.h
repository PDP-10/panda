...
/* priority.c */
extern int getpriority P_((int which,int who));
extern int setpriority P_((int which,int who,int prio));

/* wait.c */
extern int getrusage P_((int who, struct rusage *rusage));

/* gtrlim.c */
extern int setrlimit P_((int resource,struct rlimit *rlp));
