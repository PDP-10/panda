...
/* Avoid external ambiguities */
#pragma private define re_compile_pattern	recmpp
#pragma private define re_compile_fastmap	recmpf
#pragma private define re_search		resrch
#pragma private define re_search_2		resrc2
#pragma private define re_match			remtch
#pragma private define re_match_2		remtc2
...
/* cgen:regex.c */
extern char *re_compile_pattern P_((const char *pattern,int size,struct re_pattern_buffer *bufp));
extern int re_compile_fastmap P_((struct re_pattern_buffer *bufp));
extern int re_search P_((struct re_pattern_buffer *pbufp,const char *string,int size,int startpos,int range,struct re_registers *regs));
extern int re_search_2 P_((struct re_pattern_buffer *pbufp,const char *string1,int size1,const char *string2,int size2,int startpos,int range,struct re_registers *regs));
extern int re_match P_((struct re_pattern_buffer *pbufp,const char *string,int size,int pos,struct re_registers *regs));
extern int re_match_2 P_((struct re_pattern_buffer *pbufp,const char *string1,int size1,const char *string2,int size2,int pos,struct re_registers *regs));
extern char *re_comp P_((const char *s));
extern int re_exec P_((const char *s));
