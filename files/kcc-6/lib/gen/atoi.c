...
static long conv_const P_((CONST char **str,int *retf));
static long conv_oct P_((CONST char **ptr,int *retf));
static long conv_hex P_((CONST char **ptr,int *retf));
static long conv_dec P_((CONST char **ptr,int *retf));
static long conv_base P_((CONST char **ptr,int *retf,int base));
...
int base;
{
    ...
    if (endptr)
	*endptr = (char *)
		((sptr == str)		/* If pointer hasn't changed, */
