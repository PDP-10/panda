...
*/
#ifndef SWI_LIBTYPE
#define SWI_LIBTYPE "LIB"
#endif

#ifndef SWI_LIBSUFFIX		/* Define library file suffix */
#if SYS_ITS
#define SWI_LIBSUFFIX "LIB+ " SWI_LIBTYPE
#else
#define SWI_LIBSUFFIX "LIB+." SWI_LIBTYPE
#endif
#endif

#ifdef SWI_LIBPATH		/* Define library file transform */
#elif SYS_T20
#define SWI_LIBPATH "C:" SWI_LIBSUFFIX
#elif SYS_10X
#define SWI_LIBPATH "<C>" SWI_LIBSUFFIX
#elif SYS_ITS
#define SWI_LIBPATH "KC;" SWI_LIBSUFFIX
#elif SYS_WTS
#define SWI_LIBPATH SWI_LIBSUFFIX "[INC,KCC]"
#elif SYS_T10
#define SWI_LIBPATH "C:" SWI_LIBSUFFIX
#elif SYS_CSI
#define SWI_LIBPATH "SYS:" SWI_LIBSUFFIX
#else
#error Library file location must be specified for system.
#endif

#ifndef SWI_OBJTYPE
#define SWI_OBJTYPE "REL"
#endif
...
#ifndef PSMEM_LIM	/* Upper limit of code area (+1) */
#if SYS_T10+SYS_CSI+SYS_WTS
#define PSMEM_LIM 0700000	/* VMDDT starts at page 700 */
#elif SYS_T20
#define	PSMEM_LIM 0777000	/* XDDT needs last page */
#elif SYS_T20+SYS_10X
#define	PSMEM_LIM 0765000	/* UDDT vars start at page 770-2 */
#elif SYS_ITS
#define	PSMEM_LIM 01000000	/* ITS has HACTRN, needs no crufty DDT */
#endif
#endif
