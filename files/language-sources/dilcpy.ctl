...
!
@COPY (FROM) FSRC:DIL2V2.REL (TO) TSRC:DIL2V2.REL
@COPY (FROM) FSRC:DIT2V2.REL (TO) TSRC:DIT2V2.REL
@COPY (FROM) FSRC:DIX2V2.REL (TO) TSRC:DIX2V2.REL
@COPY (FROM) FSRC:DAP2V1.REL (TO) TSRC:DAP2V1.REL
@COPY (FROM) FSRC:XPN2V1.REL (TO) TSRC:XPN2V1.REL
!
